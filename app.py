...
def main():
    st.sidebar.image("logo.webp", caption='GPT', use_column_width=True)
...
def handle_chatbot_queries():
    ...
    if user_query:
        ...
        response_obj = openai.chat.completions.create(model="gpt-4o", messages=[{"role": "user", "content": user_query}])
